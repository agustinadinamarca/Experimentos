...
plot000 <-ggplot() +
      # dfKi5t2
      geom_tile(data=dfKi5t2 , aes(x=AvFNR, y=AvFPR, fill = Davg)) + 
...
plot001 <-ggplot() +
   # dfKi35t2
      geom_tile(data=dfKi35t2 , aes(x=AvFNR, y=AvFPR, fill = Davg)) + 
      scale_fill_gradient(low = "red", high = "green")
...
plot002 <-ggplot() +
      # dfKi5t10
      geom_tile(data=dfKi5t10 , aes(x=AvFNR, y=AvFPR, fill = Davg)) + 
      scale_fill_gradient(low = "red", high = "green")
print(plot002)
...
plot003 <-ggplot() +
   # dfKi35t10
      geom_tile(data=dfKi35t10 , aes(x=AvFNR, y=AvFPR, fill = Davg)) + 
      scale_fill_gradient(low = "red", high = "green")
...
data.frame(agus-metric.d)
library("tidyverse")
my_data <- as_tibble(agus-metric.d)
...
plot000 <-ggplot() +
      # dfKi5t1
      geom_tile(data=dfKi5t1 , aes(x=AvFNR, y=AvFPR, fill = Davg)) + 
      scale_fill_gradient(low = "red", high = "green")
...
plot001 <-ggplot() +
   # dfKi10t1
      geom_tile(data=dfKi10t1 , aes(x=AvFNR, y=AvFPR, fill = Davg)) + 
      scale_fill_gradient(low = "red", high = "green")
...
plot002 <-ggplot() +
   # dfKi20t1
      geom_tile(data=dfKi20t1 , aes(x=AvFNR, y=AvFPR, fill = Davg)) + 
      scale_fill_gradient(low = "red", high = "green")
print(plot002)
