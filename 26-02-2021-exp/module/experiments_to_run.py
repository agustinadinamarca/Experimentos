...
def exp(number_agents, alternatives_number, maximum_number_practical_arguments, maximum_number_epistemic_arguments, maximum_attacks_density_value, N, step, resource_boundness_density):
	...
	cwd = os.getcwd() 
	name1 = str(cwd)+"/results/"+str(dto.day)+"-"+str(dto.month)+"-"+str(dto.year)+"-"+str(dto.hour)+"-"+str(dto.minute)+"-"+str(dto.second)+"-"+str(num_random)+"__synthetic.csv"
	name2 = str(cwd)+"/results/"+str(dto.day)+"-"+str(dto.month)+"-"+str(dto.year)+"-"+str(dto.hour)+"-"+str(dto.minute)+"-"+str(dto.second)+"-"+str(num_random)+"__negotiation_taf_optimal.csv"
	fname = str(cwd)+"/results/"+str(dto.day)+"-"+str(dto.month)+"-"+str(dto.year)+"-"+str(dto.hour)+"-"+str(dto.minute)+"-"+str(dto.second)+"-"+str(num_random)+"__metrics.csv"
	#step = 2
	#M = 3
	...
	while status == False:
		...
		#if are_equal_agents_sets(taf_agents_final, taf_agents) == False:
		#	print("OK2")
