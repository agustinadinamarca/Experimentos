...
def exp(number_agents, alternatives_number, maximum_number_practical_arguments, maximum_number_epistemic_arguments, maximum_attacks_density_value, N, step, resource_boundness_densities):
	#number_agents = 3
	...
	pafs_negotiations(fname, number_agents, step, N, taf_agents, resource_boundness_densities, taf_agents_final)
