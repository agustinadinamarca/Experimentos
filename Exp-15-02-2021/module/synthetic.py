...
def create_paf_agents(taf_agents, resource_boundness_densities, semantics_r):
	paf_agents = []
	...
	for i in range(number_agents):
		...
		paf_agent = create_paf_agent(taf_agents[i], resource_boundness_densities[i], semantics_r[i], external_epistemic_arguments_labels_list)
